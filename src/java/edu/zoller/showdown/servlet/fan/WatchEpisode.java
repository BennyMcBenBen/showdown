package edu.zoller.showdown.servlet.fan;
 ...
 * @author Ben Zoller
 */
public class WatchEpisode extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        // forward to JSP
        request.getRequestDispatcher("/fan/watchepisode.jsp").forward(request, response);
    } 
