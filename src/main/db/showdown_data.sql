...
INSERT INTO showdown.show (show_title, show_description, show_image,
  ...
  'sunny.jpg', 2005, 2009);
INSERT INTO showdown.episode (show_id, season, episode, ep_title,
  ep_description, airdate) VALUES
  (LAST_INSERT_ID(), 1, 1, 'The Gang Gets Racist',
  'Charlie and Mac try to prove that they are not racist after Charlie\'s crush (an unnamed waitress) overhears Charlie saying something offensive about African Americans. Meanwhile, Dee hires a black man from her acting class to boost business for Paddy\'s Pub -- and ends up turning the pub into a gay bar.',
  '2005-04-04'
  )
;
